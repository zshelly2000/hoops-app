    ...
    <div className="overflow-x-auto rounded-xl border border-zinc-800">
      <table className="w-full min-w-[560px] text-sm">
        <thead className="bg-zinc-900">
          <tr>
            <th className="px-3 py-2 text-left text-xs font-bold uppercase tracking-wider text-zinc-500">#</th>
            <th className="px-3 py-2 text-left text-xs font-bold uppercase tracking-wider text-zinc-500">Player</th>
        ...
        <tbody className="divide-y divide-zinc-800">
          {sorted.map((p, i) => {
            ...
            return (
              <tr key={p.player_id} className="hover:bg-zinc-900/60">
                ...
                <td className="px-3 py-3 text-right text-zinc-300">{p.games_played}</td>
                <td className="px-3 py-3 text-right text-zinc-300">{p.wins}</td>
                <td className="px-3 py-3 text-right text-zinc-300">{p.losses}</td>
                <td className="px-3 py-3 text-right text-zinc-300">{formatWinPct(p.win_pct)}</td>
